...
from BigVGAN.alias_free_torch.act import Activation1d as TorchActivation1d
...
class AMPBlock1(torch.nn.Module):
    def __init__(self, h, channels, kernel_size=3, dilation=(1, 3, 5), activation=None):
        ...
        if self.h.get("use_cuda_kernel", False):
            ...
            from BigVGAN.alias_free_cuda.activation1d import Activation1d as CudaActivation1d
